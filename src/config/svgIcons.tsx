...
export const RamenIcon = ({
  ...
  >
    ...
    <path
      d="M4 12 Q8 8 12 10 Q16 8 20 12"
      stroke={fill}
      strokeWidth="2"
      fill="none"
    />
...
export const SeafoodIcon = ({
  ...
  <svg
    ...
    className={className}
  >
    <path d="M12 2C8 2 5 6 5 10s3 8 7 8 7-4 7-8-3-8-7-8z" fill={fill} />
    <path d="M12 6c-1 0-2 1-2 2s1 2 2 2 2-1 2-2-1-2-2-2z" fill="white" />
    <path d="M8 18s2 2 4 2 4-2 4-2" stroke={fill} strokeWidth="2" fill="none" />
  </svg>
);
...
export const CafeIcon = ({
  ...
  >
    <path
      ...
      fill={fill}
    />
    <path d="M7 9V7h8v2" stroke="white" strokeWidth="1" fill="none" />
  </svg>
);
...
export const YakinikuIcon = ({
  ...
  >
    ...
    <path d="M6 14h12M8 16h8M10 12h4" stroke="white" strokeWidth="1" />
    <path
