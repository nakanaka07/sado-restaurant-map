...
export function FilterModal({
  ...
  useEffect(() => {
    const updatePortalContainer = () => {
      ...
      const fullscreenElement =
        standardFullscreen || webkitFullscreen || mozFullscreen || msFullscreen;
    ...
    document.addEventListener("webkitfullscreenchange", updatePortalContainer);
    ...
    return () => {
      ...
      document.removeEventListener("msfullscreenchange", updatePortalContainer);
    };
  }, []);
  ...
  const handleTouchEnd = useCallback(
    (event: React.TouchEvent) => {
      const touchStartY = modalRef.current?.getAttribute("data-touch-start-y");
