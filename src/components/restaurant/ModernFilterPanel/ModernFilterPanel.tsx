/**
 * @fileoverview Main ModernFilterPanel component
 * メインのモダンフィルターパネルコンポーネント（分割後）
 */

import type { MapPointType } from "@/types";
import {
  useModernFilterState,
  type ModernFilterHandlers,
} from "./useModernFilterState";
import { ModernSearchFilter } from "./ModernSearchFilter";
import { ModernCuisineFilter } from "./ModernCuisineFilter";
import { ModernPriceFilter } from "./ModernPriceFilter";
import { ModernDistrictFilter } from "./ModernDistrictFilter";
import { ModernFeatureFilter } from "./ModernFeatureFilter";
import { ModernMapLegend } from "./ModernMapLegend";

interface ModernFilterPanelProps extends ModernFilterHandlers {
  loading?: boolean;
  resultCount?: number;
}
...
export function ModernFilterPanel({
  ...
  const filterState = useModernFilterState(handlers);
