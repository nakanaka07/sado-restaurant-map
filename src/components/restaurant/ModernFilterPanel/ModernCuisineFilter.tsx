/**
 * @fileoverview Modern cuisine filter component
 * モダンな料理タイプフィルターコンポーネント
 */

import type { CuisineType } from "@/types";

interface ModernCuisineFilterProps {
  value: CuisineType | "";
...
export function ModernCuisineFilter({
  value,
  onChange,
}: ModernCuisineFilterProps) {
  return (
